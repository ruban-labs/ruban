...
export default function ComponentDetailScreen(props: Props): React.ReactElement {
...
function UnknownComponentScreen({onBack}: {onBack: () => void}): React.ReactElement {
  const colors = useRubanColors();
  return (
    <RubanScreen>
      <Text style={[styles.eyebrow, {color: colors.accent}]}>COMPONENT / UNKNOWN</Text>
...
const styles = StyleSheet.create({
  eyebrow: {fontSize: 10, lineHeight: 14, fontWeight: '900', letterSpacing: 1.3},
  title: {marginTop: 12, fontSize: 42, lineHeight: 46, fontWeight: '800', letterSpacing: -1.8},
