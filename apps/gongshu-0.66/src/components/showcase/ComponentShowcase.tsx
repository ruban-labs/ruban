...
export function ComponentShowcaseScreen(
  props: ComponentShowcaseScreenProps,
): React.ReactElement {
  return (
            ...
            return (
              <Pressable
                ...
                <Text
                  ...
                  style={[
                    styles.themeLabel,
                    {color: selected ? colors.inverse : colors.faint},
                  ]}>
                  {mode.toUpperCase()}
                </Text>
              </Pressable>
  ...
  return (
    <View style={styles.section}>
      <View style={[styles.sectionHeader, {borderBottomColor: colors.ink}]}>
        <Text style={[styles.sectionIndex, {color: colors.accent}]}>
          {index}
        </Text>
...
export function ShowcaseDataRow({
  label,
  value,
}: {
  label: string;
...
export function ShowcaseDeepLink({
  children,
}: {
  children: string;
}): React.ReactElement {
  ...
  return (
    <View
      ...
      <Text style={[styles.deepLinkLabel, {color: colors.accent}]}>
        DEEP LINK
      </Text>
