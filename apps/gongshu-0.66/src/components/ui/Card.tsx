...
export function Card({
  ...
  children,
  ...viewProps
}: ViewProps & {tone?: CardTone}): React.ReactElement {
  const colors = useRubanColors();
...
export function CardTitle({
  ...
  return (
    <Text
      {...textProps}
      style={[styles.title, {color: palette.foreground}, style]}
    />
  );
}
...
export function CardDescription({
  ...
  return (
    <Text
      {...textProps}
      style={[styles.description, {color: palette.muted}, style]}
    />
  );
}
...
export function CardActionText({
  style,
  ...textProps
}: TextProps): React.ReactElement {
  const palette = useCardPalette();
  return (
    <Text
      {...textProps}
      style={[styles.actionText, {color: palette.accent}, style]}
    />
  );
}
...
export function CardFooter({
  ...
  return (
    <View
      {...viewProps}
      style={[styles.footer, {borderTopColor: palette.border}, style]}
    />
  );
}
...
export function CardMeta({style, ...textProps}: TextProps): React.ReactElement {
  const palette = useCardPalette();
  return (
    <Text {...textProps} style={[styles.meta, {color: palette.muted}, style]} />
  );
}
